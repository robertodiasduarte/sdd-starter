...
| Campo | Valor |
|---|---|
| **Objetivo** | {1-2 frases estáveis: o que esta feature entrega quando estiver pronta} |
| **Status** | 🔨 em andamento |
...
1. Corrigir a soma do total em aberto para ignorar lançamentos pagos. Reproduzir com a Padaria Aurora, lançamento de 2026-03-05. Pronto quando: o total do cliente cai ao registrar o pagamento, sem precisar recarregar a tela.
